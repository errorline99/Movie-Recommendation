...
var first_name = "https://image.tmdb.org/t/p/w200"; //WAHT TO DO TOMMORRO REMOVE CAHE SO THAT YOUR APPLICATION CAN GET NEW RESULTS
...
export default async function top(props){
    ...
    return(
        <div className="kkl">
            ...
            <img className="back-img" src={getIt[1]}></img>
            <p className="wallTitle">{lineBreak6} </p>
            <p className="wallDes">Chronicles the experiences of a formerly successful <br />banker as a prisoner in the gloomy jailhouse of Shawshank <br />after being found guilty of a crime he did not commit.<br />The film portrays the man's unique way of dealing with his new,<br /> torturous life </p>
            </div>
            <br />
